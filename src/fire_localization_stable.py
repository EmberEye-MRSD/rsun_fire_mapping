...
class FireLocalization:
   ...
   def publishHotspots(self, hotspots):
      ...
      r = R.from_matrix(self.H_imu_world[:3, :3])
      quat = r.as_quat()

      drone_location.orientation.x = quat[0]
      drone_location.orientation.y = quat[1]
      drone_location.orientation.z = quat[2]
      drone_location.orientation.w = quat[3]
